...
public class VNFProperties implements DescriptorInformationElement {
	...
	public VNFProperties(String descriptorId, String descriptorVersion, String provider,
			String productName, String softwareVersion, String productInfoName, ArrayList<String> vnfmInfo,
			String flavourId, String flavourDescription) {
	...
	public VNFProperties(VNFNode vnfNode, String descriptorId, String descriptorVersion, String provider,
			String productName, String softwareVersion, String productInfoName, ArrayList<String> vnfmInfo,
			String flavourId, String flavourDescription) {
	...
	public VNFProperties(VNFNode vnfNode, String descriptorId, String descriptorVersion, String provider,
			String productName, String softwareVersion, String productInfoName, String productInfoDescription,
			List<String> vnfmInfo, List<String> localizationLanguages, String defaultLocalizationLanguage,
			VnfConfigurableProperties configurableProperties, VnfInfoModifiableAttributes modifiableAttributes,
			String flavourId, String flavourDescription) {
		this.vnfNode = vnfNode;
		this.descriptorId = descriptorId;
		this.descriptorVersion = descriptorVersion;
