...
public class VnfcConfigurableProperties implements DescriptorInformationElement {
	...
	private Map<String, String> additionalVnfcConfigurableProperties = new HashMap<String, String>();

	public VnfcConfigurableProperties() {

	}

	public VnfcConfigurableProperties(Map<String, String> additionalVnfcConfigurableProperties) {
	...
	public Map<String, String> getAdditionalVnfcConfigurableProperties() {
