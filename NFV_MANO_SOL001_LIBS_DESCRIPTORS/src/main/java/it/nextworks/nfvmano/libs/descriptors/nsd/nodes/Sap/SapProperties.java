...
public class SapProperties extends CpProperties {
	...
	public SapProperties(LayerProtocol layerProtocol, CpRole role, String description,
	...
	public SapProperties(SapNode sapNode, LayerProtocol layerProtocol, CpRole role, String description,
			ArrayList<CpProtocolData> protocolData, boolean trunkMode, boolean sapAddressAssignment) {
		super(null, layerProtocol, role, description, protocolData, trunkMode);
